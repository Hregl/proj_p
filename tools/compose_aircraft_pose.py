...
def main():
    ...
    print(f'yaw:   {yaw:.4f} deg  ({yaw*60:.2f} arcmin)')
    ...
    with open(args.output, 'w') as f:
        f.write('yaw_deg,pitch_deg,roll_deg,yaw_arcmin,pitch_arcmin,roll_arcmin,board_rmse_px,aircraft_rmse_px\n')
        f.write(f'{yaw:.6f},{pitch:.6f},{roll:.6f},{yaw*60:.4f},{pitch*60:.4f},{roll*60:.4f},{board_rmse:.4f},{ac_rmse:.4f}\n')
    print(f'-> {args.output}')
